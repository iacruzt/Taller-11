    ...
    public Calculator4() {
        ...
        ActionListener l = new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                catch ( NumberFormatException myLittlePony )
                {
                    JOptionPane.showMessageDialog ( Calculator4.this , "You didn't enter two numbers, you donkey!" ,
                            "DUNKEY!" , JOptionPane.ERROR_MESSAGE );
                }
